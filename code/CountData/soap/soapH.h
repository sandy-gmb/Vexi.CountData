...
SOAP_FMAC3 void SOAP_FMAC4 soap_default_ns1__EResetMode(struct soap*, enum ns1__EResetMode *);
...
inline enum ns1__EResetMode * soap_new_ns1__EResetMode(struct soap *soap, int n = -1)
{	return static_cast<enum ns1__EResetMode *>(soap_malloc(soap, (n < 0 ? 1 : n) * sizeof(enum ns1__EResetMode)));
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || soap_put_ns1__EResetMode(soap, p, "ns1:EResetMode", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
SOAP_FMAC3 void SOAP_FMAC4 soap_default_ns1__CodeDetection(struct soap*, enum ns1__CodeDetection *);
...
inline enum ns1__CodeDetection * soap_new_ns1__CodeDetection(struct soap *soap, int n = -1)
{	return static_cast<enum ns1__CodeDetection *>(soap_malloc(soap, (n < 0 ? 1 : n) * sizeof(enum ns1__CodeDetection)));
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || soap_put_ns1__CodeDetection(soap, p, "ns1:CodeDetection", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns1:ChangeSamplesResponse-ChangeSamplesResult", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns1:GetVersionsResponse-GetVersionsResult", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns1:ChangeMoldsInSampleTableResponse-ChangeMoldsInSampleTableResult", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns1:EraseMoldsInSampleTableResponse-EraseMoldsInSampleTableResult", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns1:ChangeMountedMoldsResponse-ChangeMountedMoldsResult", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns1:GetMoldsInSampleTableResponse-GetMoldsInSampleTableResult", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns1:EjectedMoldsResponse-EjectedMoldsResult", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns1:ReadenMoldsResponse-ReadenMoldsResult", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns1:CumulCountsResponse-CumulCountsResult", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns1:MeasuresResponse-MeasuresResult", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns1:MountedMoldsResponse-MountedMoldsResult", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns1:GetAlarmsResponse-GetAlarmsResult", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns1:GetAlarmsSinceLastQueryResponse-GetAlarmsSinceLastQueryResult", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns1:CountsResponse-CountsResult", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns1:ChangeSamplesResponse", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns1:ChangeSamples", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns1:GetVersionsResponse", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns1:GetVersions", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns1:ChangeMoldsInSampleTableResponse", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns1:ChangeMoldsInSampleTable", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns1:EraseMoldsInSampleTableResponse", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns1:EraseMoldsInSampleTable", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns1:AddEjectedMoldsResponse", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns1:AddEjectedMolds", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns1:ChangeMountedMoldsResponse", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns1:ChangeMountedMolds", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns1:GetMoldsInSampleTableResponse", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns1:GetMoldsInSampleTable", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns1:EjectedMoldsResponse", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns1:EjectedMolds", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns1:ReadenMoldsResponse", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns1:ReadenMolds", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns1:CumulCountsResponse", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns1:CumulCounts", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns1:MeasuresResponse", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns1:Measures", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns1:MountedMoldsResponse", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns1:MountedMolds", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns1:GetAlarmsResponse", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns1:GetAlarms", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns1:GetAlarmsSinceLastQueryResponse", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns1:GetAlarmsSinceLastQuery", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns1:CountsResponse", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns1:Counts", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns1:PrelevementUnitaire", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns1:ArrayOfPrelevementUnitaire", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns1:MoulesPrelevesXml", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns1:PrelevementWS_1_0_9", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns1:MoulesPrelevesXmlPourWS1_0_9", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns1:RejetMoule", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns1:RejetMouleVue", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns1:ArrayOfRejetMouleVue", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns1:MoulesEjectesXml", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns1:Moule", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns1:ArrayOfMoule", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns1:MountedMoldsXml", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (soap_serialize___ns1__ChangeSamples_(soap, p), 0) || soap_put___ns1__ChangeSamples_(soap, p, "-ns1:ChangeSamples", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (soap_serialize___ns1__GetVersions_(soap, p), 0) || soap_put___ns1__GetVersions_(soap, p, "-ns1:GetVersions", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (soap_serialize___ns1__ChangeMoldsInSampleTable_(soap, p), 0) || soap_put___ns1__ChangeMoldsInSampleTable_(soap, p, "-ns1:ChangeMoldsInSampleTable", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (soap_serialize___ns1__EraseMoldsInSampleTable_(soap, p), 0) || soap_put___ns1__EraseMoldsInSampleTable_(soap, p, "-ns1:EraseMoldsInSampleTable", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (soap_serialize___ns1__AddEjectedMolds_(soap, p), 0) || soap_put___ns1__AddEjectedMolds_(soap, p, "-ns1:AddEjectedMolds", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (soap_serialize___ns1__ChangeMountedMolds_(soap, p), 0) || soap_put___ns1__ChangeMountedMolds_(soap, p, "-ns1:ChangeMountedMolds", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (soap_serialize___ns1__GetMoldsInSampleTable_(soap, p), 0) || soap_put___ns1__GetMoldsInSampleTable_(soap, p, "-ns1:GetMoldsInSampleTable", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (soap_serialize___ns1__EjectedMolds_(soap, p), 0) || soap_put___ns1__EjectedMolds_(soap, p, "-ns1:EjectedMolds", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (soap_serialize___ns1__ReadenMolds_(soap, p), 0) || soap_put___ns1__ReadenMolds_(soap, p, "-ns1:ReadenMolds", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (soap_serialize___ns1__CumulCounts_(soap, p), 0) || soap_put___ns1__CumulCounts_(soap, p, "-ns1:CumulCounts", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (soap_serialize___ns1__Measures_(soap, p), 0) || soap_put___ns1__Measures_(soap, p, "-ns1:Measures", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (soap_serialize___ns1__MountedMolds_(soap, p), 0) || soap_put___ns1__MountedMolds_(soap, p, "-ns1:MountedMolds", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (soap_serialize___ns1__GetAlarms_(soap, p), 0) || soap_put___ns1__GetAlarms_(soap, p, "-ns1:GetAlarms", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (soap_serialize___ns1__GetAlarmsSinceLastQuery_(soap, p), 0) || soap_put___ns1__GetAlarmsSinceLastQuery_(soap, p, "-ns1:GetAlarmsSinceLastQuery", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (soap_serialize___ns1__Counts_(soap, p), 0) || soap_put___ns1__Counts_(soap, p, "-ns1:Counts", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (soap_serialize___ns1__ChangeSamples(soap, p), 0) || soap_put___ns1__ChangeSamples(soap, p, "-ns1:ChangeSamples", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (soap_serialize___ns1__GetVersions(soap, p), 0) || soap_put___ns1__GetVersions(soap, p, "-ns1:GetVersions", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (soap_serialize___ns1__ChangeMoldsInSampleTable(soap, p), 0) || soap_put___ns1__ChangeMoldsInSampleTable(soap, p, "-ns1:ChangeMoldsInSampleTable", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (soap_serialize___ns1__EraseMoldsInSampleTable(soap, p), 0) || soap_put___ns1__EraseMoldsInSampleTable(soap, p, "-ns1:EraseMoldsInSampleTable", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (soap_serialize___ns1__AddEjectedMolds(soap, p), 0) || soap_put___ns1__AddEjectedMolds(soap, p, "-ns1:AddEjectedMolds", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (soap_serialize___ns1__ChangeMountedMolds(soap, p), 0) || soap_put___ns1__ChangeMountedMolds(soap, p, "-ns1:ChangeMountedMolds", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (soap_serialize___ns1__GetMoldsInSampleTable(soap, p), 0) || soap_put___ns1__GetMoldsInSampleTable(soap, p, "-ns1:GetMoldsInSampleTable", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (soap_serialize___ns1__EjectedMolds(soap, p), 0) || soap_put___ns1__EjectedMolds(soap, p, "-ns1:EjectedMolds", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (soap_serialize___ns1__ReadenMolds(soap, p), 0) || soap_put___ns1__ReadenMolds(soap, p, "-ns1:ReadenMolds", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (soap_serialize___ns1__CumulCounts(soap, p), 0) || soap_put___ns1__CumulCounts(soap, p, "-ns1:CumulCounts", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (soap_serialize___ns1__Measures(soap, p), 0) || soap_put___ns1__Measures(soap, p, "-ns1:Measures", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (soap_serialize___ns1__MountedMolds(soap, p), 0) || soap_put___ns1__MountedMolds(soap, p, "-ns1:MountedMolds", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (soap_serialize___ns1__GetAlarms(soap, p), 0) || soap_put___ns1__GetAlarms(soap, p, "-ns1:GetAlarms", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (soap_serialize___ns1__GetAlarmsSinceLastQuery(soap, p), 0) || soap_put___ns1__GetAlarmsSinceLastQuery(soap, p, "-ns1:GetAlarmsSinceLastQuery", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (soap_serialize___ns1__Counts(soap, p), 0) || soap_put___ns1__Counts(soap, p, "-ns1:Counts", NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
