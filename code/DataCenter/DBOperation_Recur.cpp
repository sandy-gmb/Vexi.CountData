...
bool DBOperation_Recur::QuerySensorAddingInfoBySensorID(QSharedPointer<QSqlDatabase> _db, int sensorrowid, QMap<QString, int>& addinginfo, QString* err)
{
    {//查询sensoradd信息
...
bool DBOperation_Recur::SaveSensorAddingInfoBySensorID(QSharedPointer<QSqlDatabase> _db, int sensorrowid, const QMap<QString, int>& addinginfo, QString* err)
{
    bool res = true;
    QSqlQuery query(*_db);
